...
export const sanitizeTransactionStatus = query("status").customSanitizer((value: string) => {
  /* istanbul ignore if*/
...
export const sanitizeRequestStatus = query("requestStatus").customSanitizer((value: string) => {
  /* istanbul ignore if*/
