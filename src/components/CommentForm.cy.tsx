...
describe("CommentForm", () => {
  it("renders the comment input", () => {
    ...
    cy.mount(<CommentForm transactionId="tx-123" transactionComment={transactionComment} />);
  ...
  it("renders with correct placeholder", () => {
    const transactionComment = cy.stub();
    cy.mount(<CommentForm transactionId="tx-456" transactionComment={transactionComment} />);

    cy.get("[data-test=transaction-comment-input-tx-456]").should(
      "have.attr",
      "placeholder",
      "Write a comment..."
    );
