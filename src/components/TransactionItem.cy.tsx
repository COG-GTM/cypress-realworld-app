...
describe("TransactionItem", () => {
  const transaction: TransactionResponseItem = {
    ...
    createdAt: new Date(),
    modifiedAt: new Date(),
    likes: [{ id: "like-1", uuid: "l-uuid", userId: "user-3", transactionId: "tx-1", createdAt: new Date(), modifiedAt: new Date() }],
    comments: [{ id: "comment-1", uuid: "c-uuid", content: "Nice!", userId: "user-3", transactionId: "tx-1", createdAt: new Date(), modifiedAt: new Date() }],
