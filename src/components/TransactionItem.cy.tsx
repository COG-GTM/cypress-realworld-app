...
const transaction: TransactionResponseItem = {
  ...
  likes: [{ id: "l1", uuid: "lu1", userId: "user3", transactionId: "tx1", createdAt: new Date(), modifiedAt: new Date() }],
  comments: [{ id: "c1", uuid: "cu1", content: "Nice", userId: "user3", transactionId: "tx1", createdAt: new Date(), modifiedAt: new Date() }],
